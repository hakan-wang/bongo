...
> that catches agents faking success." The current canonical direction is **Assay = make
> cheap models reliable + cut cost** (see [`/info/SOURCE-OF-TRUTH.md`](../info/SOURCE-OF-TRUTH.md)).
> The deterministic-verification insight below is now Assay's VERIFY step. Keep this doc for
