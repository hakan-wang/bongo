...
Assay is vendor-neutral: the cheap model and the strong model can be on DIFFERENT providers.
Used by demo/real_proof.py (the real cross-provider proof) and demo/gateway.py (the wired
"point your base_url at Assay" path). Each function reads its key from the environment.
"""
import json
import os
import re
