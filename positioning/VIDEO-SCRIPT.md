...
- **Cut to:** the planted ground-truth value flashing next to the wrong one. Counter: **"COST OF SHIPPING THIS BUG: $8.87M."**
...
- **On-screen:** same trade ticket, now through Assay. Horizontal agent trace, step by step.
...
- **VO:** "There. Assay caught the exact step, before the wire."
...
- **On-screen:** scoreboard. Cheap-alone **60%** correct. Assay **100%**. Escalation counter: **"47 steps stayed cheap, 2 escalated."** Cost: **78% cheaper than frontier-on-every-step.**
- **VO:** "Cheap model alone: sixty-seven percent correct — and you'd never know which third was wrong. With Assay: a hundred percent, because reality checked every step. Forty-seven steps stayed cheap; we only paid for the strong model on the three that needed it. Sixty-two percent cheaper than running frontier everywhere — but cost was never the point. Correctness was."
...
- **VO:** "Two lines. Point your agent at Assay, keep your own model and keys, and it stops shipping silently-wrong steps. Assay — the independent reliability layer that catches your agent's bad steps against reality, and fixes only the step that broke."
- **Final frame:** Assay wordmark + one line: *"Keep your model. We verify it against reality."*
