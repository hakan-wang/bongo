# PITCH-DECK.md — Assay (YC structure, rubric-mapped)
...
## Slide 1 — Title / Hook
- **Assay** wordmark. Tagline: *"Keep your model. We verify it against reality."*
...
- 4-column matrix: **cross-provider / runtime / per-step correctness / active-fix.** Only Assay has all four checks.
...
- **Channels:** (1) warm founder network — 15-min "watch it break, watch Assay save it" calls; (2) agent-builder communities (LiteLLM / OpenRouter / LangChain) with the free open-core base_url proxy as PLG top-of-funnel; (3) hackathon/sponsor ecosystem (Mistral, Datadog) — literal ICP.
